...
<g>
    ...
    public static function generateFAQ() {
        $page = "";

        $faq = \R::findAll("faq");

        foreach ($faq as $f) {
            $text = (mb_strlen($f->answer) > 65) ? mb_substr($f->answer, 0, 65) . "..." : $f->answer;
            ...
            $page .= "<tr>
                            ...
                            <td>
                                <div class=\"controls\">
                                    <button class=\"btn edit\" onclick=\"editFAQ(" . $f->id . ")\">
                                        <svg version=\"1.1\" id=\"Capa_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\"
                                                                  viewBox=\"0 0 268.7 268.7\" style=\"enable-background:new 0 0 268.7 268.7;\" xml:space=\"preserve\">
<g id=\"Edit\">
    <path d=\"M161.4,56.3c-7-7-18.5-7-25.5,0l-6.4,6.4l-89.2,89.3l0,0l-2.8,2.8c0,0-9,9-29.2,74.4c-0.1,0.5-0.3,0.9-0.4,1.4
		...
		C270.4,74.8,270.4,63.4,263.4,56.3z\"/>
                                    ...
                                    <button class=\"btn delete\" onclick='deleteFAQ(" . $f->id . ")'>
                                        <svg version=\"1.1\" id=\"Capa_1\" xmlns=\"http://www.w3.org/2000/svg\"
                                             xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\"
                                             viewBox=\"0 0 459 459\" style=\"enable-background:new 0 0 459 459;\" xml:space=\"preserve\">
	<g id=\"delete\">
    ...
    public static function getFAQ() {
        $questions = \R::findAll("faq");

        $page = "";

        foreach ($questions as $question) {

            $page .= "<div class=\"faq__block\">
