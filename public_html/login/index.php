...
if (isset($_SESSION["user"])) {
        ...
        <nav>
            <div class="menu_bar">
                ...
                <div class="menu_buttons">
                    <div class="enter">
                        <a href="/login">
                            <svg enable-background="new 0 0 67 67" version="1.1" viewBox="0 0 67 67"
                                 xml:space="preserve">
                                <path fill="#71aa27"
    ...
    <section id="login">
        ...
        <div class="container forgot" style="display: none;">
            ...
            <input type="submit" id="forgot" name="forgot" value="Восстановить пароль" disabled>
        </div>
        <div class="container success" style="display: none;">
            <div class="icon">
                ...
                <path d="M26,0C11.7,0,0,11.7,0,26s11.7,26,26,26s26-11.7,26-26S40.3,0,26,0z M26,50C12.8,50,2,39.2,2,26S12.8,2,26,2s24,10.8,24,24   S39.2,50,26,50z"/>
                    <path d="m22.6 38h-0.3c-0.3-0.1-0.6-0.4-0.6-0.7l-0.4-7-10.2-3.1c-0.6-0.2-1-0.7-1.1-1.4 0-0.6 0.3-1.2 0.9-1.5l26.3-10.7c0.1 0 0.2-0.1 0.3-0.1 0.2 0 0.4 0.1 0.5 0.2 0.2 0.2 0.4 0.5 0.3 0.8l-4.3 21.8c-0.2 0.7-0.8 1.2-1.5 1.2-0.3 0-0.6-0.1-0.9-0.3l-5-3.5-3.5 3.9c0 0.3-0.3 0.4-0.5 0.4zm10-2.3l3.6-18.5-12.7 12.3 9.1 6.2zm-9.3-0.6l2-2.3-2.2-1.5 0.2 3.8zm-1.4-6.5l12.4-12-22.1 9 9.7 3z"/>
            </svg>
    ...
    <script>
        ...
        $("input#email").on("input", function (e) {
            $("input#forgot").attr("disabled", false);
        });
