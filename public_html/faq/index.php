...
<header>
        ...
        <div class="menu_bar">
            ...
            <div class="hidden_menu menu_visible">
                <div class="hidden_menu_item">
                    <a href="/">Проект</a>
                    <a href="/faq" class="active">Вопросы</a>
    ...
    <div class="header_item">
        ...
        <a href="/faq" class="header_info_link active">Вопросы</a>
...
<section class="navigation" style="padding: 1.625rem 6rem;">
    <nav>
        <a href="/"><span class="nav_link">Главная</span></a>
        <a href="/faq"><span class="last_nav_title">Вопросы</span></a>
    </nav>
</section>

<section id="faq">
    <h1 class="title_style">Часто задаваемые вопросы</h1>
    <?= ViewGenerator::getFAQ() ?>
</section>

<section class="submit" style="text-align: -webkit-center;padding-top: 1.25rem">
            ...
            <div class="more__block">
                ...
                <form action="">
                    ...
                    <textarea name="" id="" cols="30" rows="10"
                              placeholder="Задайте интересующий вас вопрос..."></textarea>
