...
$info = R::findOne("info", "WHERE userid=:userid", ["userid" => $_GET["id"]]);
$type = R::findOne($user->type, "WHERE userid=:userid", ["userid" => $_GET["id"]]);
    ...
    <circle cx="61.4" cy="26" r="13.9"/>
            ...
            <div class="content">
                ...
                <div class="container">
                    ...
                    <form action="/admin/add/success/user/<?=$user->id?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="first">
                            <div class="block">
                                ...
                                <div class="body">
                                    ...
                                    <input type="text" id="surname" name="surname" placeholder="Фамилия" value="<?=$info->surname?>">

                                    <label for="name">Имя</label>
                                    <input type="text" id="name" name="name" placeholder="Имя" value="<?=$info->name?>">

                                    <label for="middlename">Фамилия</label>
                                    <input type="text" id="middlename" name="middlename" placeholder="Отчество" value="<?=$info->midname?>">
                                </div>
                            </div>
                                ...
                                <div class="body" id="contact">
                                    ...
                                    <div class="tel">
                                        <input type="tel" id="tel" name="tel" placeholder="Телефон"
                                               style="width: 72%;margin-right: 5%" value="<?=$info->phoneprimary?>">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="E-mail" value="<?=$user->login?>">

                                    <input type="hidden" value=1 id="count">
                                </div>
                            </div>

                            <div class="block" id="physical" style="display:none;">
                                <div class="title">
                                ...
                                <div class="body">
                                    <div style="display: flex">
                                        <div style="width: 25%;margin-right: 5%">
                                            ...
                                            <input type="text" id="seriya" name="seriya" value="<?=$type->serie?>">
                                        </div>
                                        <div style="width: 70%;">
                                            <label for="nomer">Номер</label>
                                            <input type="text" id="nomer" name="nomer" value="<?=$type->number?>">
                                        </div>
                                    </div>

                                    <label for="vydan">Выдан</label>
                                    <input type="text" id="vydan" name="vydan" value="<?=$type->structure?>">

                                    <div style="display: flex">
                                        <div style="width: 45%;margin-right: 10%;">
                                            <label for="p_date">Дата выдачи</label>
                                            <input type="text" id="p_date" name="p_date" value="<?=$type->date?>">
                                        </div>
                                        <div style="width: 45%;">
                            ...
                            <div class="block" id="company" style="display: none;margin: 0;">
                                <div class="title">
