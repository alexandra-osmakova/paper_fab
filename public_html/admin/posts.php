			...
			V25.5z"/>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>21-02-2018</td>
                            <td>Управление и развитие</td>
                            <td>Не следует, однако забывать, что укрепление и развитие структуры требуют определения ...</td>
                            <td>
                                <div class="controls">
                                    <button class="btn view"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
    ...
    <circle cx="466.075" cy="466.025" r="134.5"/>
                                    ...
                                    <button class="btn edit" onclick="editPost(1)"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	<g id="delete">
        ...
        <script>
            ...
            $("#check_all").on("change", function (e) {
                $("input[type='checkbox']").attr("checked", e.currentTarget.checked);
            });
        </script>
        </body>
        </html>
