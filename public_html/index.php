...
<body>
    ...
    <section class="advantages">
        ...
        <div class="advantages_content"></div>
    </section>
            ...
            <div class="safety_content_item">
                <div>
                    <svg width="512pt" height="512pt" version="1.1" viewBox="0 0 512 512">
                        <g>
                            <path fill="#ffffff" d="m77.109 401.66h-21.945c-30.418 0-55.164 24.75-55.164 55.168v40.168c0 8.2852 6.7148 15 15 15h64.691c-1.668-4.6953-2.582-9.7422-2.582-15z" />
                            <path fill="#ffffff" d="m184.22 321.33h-21.941c-30.418 0-55.168 24.75-55.168 55.168v120.5c0 8.2852 6.7148 15 15 15h64.691c-1.6641-4.6953-2.582-9.7422-2.582-15z" />
                            <path fill="#ffffff" d="m509.05 150.67l-107.11-144.6c-2.832-3.8164-7.3008-6.0703-12.055-6.0703-4.7539 0-9.2266 2.2539-12.055 6.0703l-107.11 144.6c-3.3711 4.5508-3.8906 10.617-1.3438 15.676 2.5508 5.0586 7.7305 8.2539 13.398 8.2539h38.555v322.4c0 8.2852 6.7148 15 15 15h107.11c8.2852 0 15-6.7148 15-15v-322.4h38.559c5.6641 0 10.848-3.1953 13.395-8.2539 2.5508-5.0586 2.0312-11.125-1.3398-15.676z" />
                            <path fill="#ffffff" d="m291.33 241h-21.945c-30.418 0-55.168 24.746-55.168 55.164v200.84c0 8.2852 6.7188 15 15 15h64.691c-1.6641-4.6953-2.5781-9.7422-2.5781-15z" />
                        </g>
                    </svg>
                </div>
            ...
            <div class="safety_content_item">
                <div>
                    <svg enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512" xml:space="preserve">
                        <path fill="#ffffff" d="m493.56 431.87l-58.716-125.91c-32.421 47.207-83.042 80.822-141.64 91.015l49.152 105.4c6.284 13.487 25.732 12.587 30.793-1.341l25.193-69.204 5.192-2.421 69.205 25.193c13.887 5.096 27.096-9.296 20.82-22.73z" />
                        ...
                        <path fill="#ffffff" d="m77.156 305.96l-58.716 125.91c-6.305 13.497 7.023 27.81 20.821 22.727l69.204-25.193 5.192 2.421 25.193 69.205c5.051 13.899 24.496 14.857 30.793 1.342l49.152-105.4c-58.597-10.192-109.22-43.806-141.64-91.014z" />
                    </svg>
                </div>
            ...
            <div class="production_stages_content_item">
                <div class="production_step">
                    ...
                    <div class="production_step__text">Газеты, бумажные пакеты,<br>
                        старые картонки летят в завод</div>
                </div>
                <div class="production_step">
                    ...
                    <div class="production_step__text">Внутри завода из них удаляется клей, <br>
                        ...
                        превращается в чистую массу</div>
                </div>
                <div class="production_step">
        ...
        <div class="profit_content">
            ...
            <div class="profit_content_item profit_content_title_first profit_content_title">
                <div class="profit_content_title_first">ДОХОД <br>
                    (выручка от реализации товаров)</div>
            </div>
    ...
    <section class="experts_view">
        ...
        <div class="expert_view_pagination">
            <div class="expert_view_prev">
                ...
                <svg enable-background="new 0 0 86.001 86.001" version="1.1" viewBox="0 0 86.001 86.001" xml:space="preserve">
