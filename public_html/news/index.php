            ...
            <div class="subscribe_content fixed_content_all_news">
                ...
                <section class="subscribe">
                    <form id="prompt-form" method="post" action="thanks_window.php">
                        <input class="modal_window_input" name="name" type="email" id="masked_email" placeholder="Введите Ваш E-mail" pattern='[A-Za-z]^[ 0-9]+$\D [^0-9]'>
