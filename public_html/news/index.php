...
<section class="news_block">
    ...
    <div class="news_block_item">
        <div class="subscribe_content fixed_content_all_news">
            <h3 class='subscribe_title'>Узнать больше<br>о проекте</h3>
            <section class="subscribe">
                <form id="prompt-form" method="post" action="/thanx_page.php">
                    <input class="modal_window_input" name="name" type="email" id="masked_email"
                           placeholder="Введите Ваш E-mail" pattern='[A-Za-z]^[ 0-9]+$\D [^0-9]' required>
...
<section class="modal_window_second invisible_item">
    ...
    <form id="prompt-form" method="post" action="thanks_window.php">
        ...
        <input class="modal_window_input phone-number" id="selector" name="phone-number" type="text"
