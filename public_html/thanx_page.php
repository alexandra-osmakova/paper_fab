...
<body>
    <section class="main_thanx">
        <svg enable-background="new 0 0 52 52" version="1.1" viewBox="0 0 52 52" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
            <path fill="#71aa27" d="M26,0C11.664,0,0,11.663,0,26s11.664,26,26,26s26-11.663,26-26S40.336,0,26,0z M26,50C12.767,50,2,39.233,2,26   S12.767,2,26,2s24,10.767,24,24S39.233,50,26,50z" />
            <path fill="#71aa27" d="m38.252 15.336l-15.369 17.29-9.259-7.407c-0.43-0.345-1.061-0.274-1.405 0.156-0.345 0.432-0.275 1.061 0.156 1.406l10 8c0.184 0.147 0.405 0.219 0.625 0.219 0.276 0 0.551-0.114 0.748-0.336l16-18c0.367-0.412 0.33-1.045-0.083-1.411-0.414-0.368-1.045-0.331-1.413 0.083z" />
        </svg>
        <h2>Спасибо <br> за вашу заявку!</h2>
        <p>Через некоторое время наши менеджеры свяжутся с вами. <br>
            Вы будете перенаправлены на главную через <span class="counter_back"><span class="counter_back_num">5</span>
                секунд</span></p>
    </section>
    <script>
