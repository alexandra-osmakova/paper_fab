...
<body>
    <header>
        ...
        <div class="header_item">
            ...
            <a href="" class="header_info_link">Новости</a>
        </div>
        <div class="header_item">
    ...
    <section class="news_block">
        <div class="news_block_item">
            <h1 class="title_style">Президент республики Татарстан
                пришел на открытие завода</h1>
            <div class="news_block_item_content">
                ...
                <p class="news_page_text">Разнообразный и богатый опыт новая модель организационной деятельности
                    ...
                    форм развития.</p>
                <span class="publishing_date">21 ноября в 17:05</span>
