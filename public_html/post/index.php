...
<body>
    ...
    <nav>
        <div class="menu_bar">
            ...
            <div class="menu_buttons">
                <button class="enter" onclick="login()">
    ...
    <div class="header_item">
        ...
        <button class="header_item__button" onclick="login()">Личный кабинет</button>
    </div>
</header>
    ...
    <section class="news_block">
        <div class="news_block_item">
            ...
            <div class="news_block_item_content">
                <?=$post->text?>
<!--                <p class="news_page_text">Дальнейшее развитие различных форм деятельности влечет за собой процесс-->
<!--                    внедрения и модернизации соответствующий условий активизации. Разнообразный и богатый опыт-->
<!--                    реализация намеченных плановых заданий обеспечивает широкому кругу (специалистов) участие в-->
<!--                    формировании системы обучения кадров, соответствует насущным потребностям. Равным образом-->
<!--                    постоянное информационно-пропагандистское обеспечение нашей деятельности способствует подготовки и-->
<!--                    реализации модели развития. Равным образом рамки и место обучения кадров позволяет выполнять важные-->
<!--                    задания по разработке модели развития.</p>-->
<!--                <div class="main_news news_page_img"></div>-->
<!--                <p class="news_page_text">Равным образом дальнейшее развитие различных форм деятельности влечет за-->
<!--                    собой процесс внедрения и модернизации направлений прогрессивного развития. Товарищи! новая модель-->
<!--                    организационной деятельности требуют определения и уточнения систем массового участия.-->
<!--                </p>-->
<!--                <p class="news_page_text">Не следует, однако забывать, что реализация намеченных плановых заданий-->
<!--                    обеспечивает широкому кругу (специалистов) участие в формировании системы обучения кадров,-->
<!--                    соответствует насущным потребностям. Разнообразный и богатый опыт постоянное-->
<!--                    информационно-пропагандистское обеспечение нашей деятельности позволяет выполнять важные задания по-->
<!--                    разработке новых предложений. Повседневная практика показывает, что новая модель организационной-->
<!--                    деятельности играет важную роль в формировании системы обучения кадров, соответствует насущным-->
<!--                    потребностям.</p>-->
<!--                <p class="news_page_text">-->
<!--                    Не следует, однако забывать, что укрепление и развитие структуры позволяет оценить значение-->
<!--                    существенных финансовых и административных условий. Разнообразный и богатый опыт консультация с-->
<!--                    широким активом обеспечивает широкому кругу (специалистов) участие в формировании направлений-->
<!--                    прогрессивного развития. Повседневная практика показывает, что консультация с широким активом-->
<!--                    позволяет оценить значение направлений прогрессивного развития. Повседневная практика показывает,-->
<!--                    что постоянное информационно-пропагандистское обеспечение нашей деятельности требуют определения и-->
<!--                    уточнения направлений прогрессивного развития. Разнообразный и богатый опыт постоянный-->
<!--                    количественный рост и сфера нашей активности обеспечивает широкому кругу (специалистов) участие в-->
<!--                    формировании направлений прогрессивного развития. Не следует, однако забывать, что консультация с-->
<!--                    широким активом позволяет оценить значение модели развития.</p>-->
<!--                <p class="news_page_text">Разнообразный и богатый опыт новая модель организационной деятельности-->
<!--                    позволяет выполнять важные задания по разработке существенных финансовых и административных-->
<!--                    условий. Товарищи! постоянный количественный рост и сфера нашей активности требуют от нас анализа-->
<!--                    форм развития.</p>-->
                    ...
                    <a href="/post/<?=($opt["prev"] === null) ? $_GET["id"] : $opt["prev"]?>" class="news_arrow_btn">
                        <div>
                            <svg class="prev_page" enable-background="new 0 0 86.001 86.001" version="1.1" viewBox="0 0 86.001 86.001"
                                xml:space="preserve">
                                <path fill="#71aa27" d="m5.907 21.004c-1.352-1.338-3.542-1.338-4.894 0-1.35 1.336-1.352 3.506 0 4.844l39.54 39.15c1.352 1.338 3.542 1.338 4.894 0l39.54-39.15c1.351-1.338 1.352-3.506 0-4.844s-3.542-1.338-4.894-2e-3l-37.093 35.705-37.093-35.703z" />
                            </svg>
                        </div>
        ...
        <div class="news_block_item">
            <div class="subscribe_content fixed_content_news_page invisible_item">
        ...
        <div class="footer_item">
            <div class="footer_links">
                ...
                <div class="footer_links_container">
                    <div>
                        ...
                        <a href="" class="footer_info_link">Новости</a>
                    </div>
                    <div>
            ...
            <div class="footer_contacts">
                <div class="footer_contacts_item">
                    ...
                    <div class="footer_contact_item_piece">
                        <div>
                            <svg enable-background="new 0 0 14 14" version="1.1" viewBox="0 0 14 14" xml:space="preserve">
                                <path fill="#77a103" d="M7,9L5.3,7.5l-5,4.2C0.5,11.9,0.7,12,1,12h12c0.3,0,0.5-0.1,0.7-0.3L8.7,7.5L7,9z"></path>
                                <path fill="#77a103" d="M13.7,2.3C13.5,2.1,13.3,2,13,2H1C0.7,2,0.5,2.1,0.3,2.3L7,8L13.7,2.3z"></path>
                                <polygon fill="#77a103" points="0 2.9 0 11.2 4.8 7.1"></polygon>
                                <polygon fill="#77a103" points="9.2 7.1 14 11.2 14 2.9"></polygon>
                            </svg>
                        </div>
                        <span>www.f-karton.ru</span>
                    </div>
                </div>
                <div class="footer_contacts_item">
    ...
    <script>
        ...
        function hide_el() {
            ...
            if (offset > (windowHeight * 0.65) || offset < (windowHeight * 0.2)) {
                item_to_scroll.classList.add('invisible_item');
            } else {
                item_to_scroll.classList.remove('invisible_item');
            }
        }
